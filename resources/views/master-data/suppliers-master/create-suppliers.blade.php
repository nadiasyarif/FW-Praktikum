                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        <x-auth-session-status class="mb-4" :status="session('success')" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="supplier_address" name="supplier_address" class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required></textarea>
                            </div>
